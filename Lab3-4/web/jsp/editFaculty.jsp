...
<body>
<form method="post" action="${pageContext.request.contextPath}/editFaculty" class="applicationForm">
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form>
                <input type="text" id="Name" class="fadeIn first" name="Name" placeholder="<fmt:message key="viewFaculties.Name"/>" required>
                <input type="text" id="BudgetPlacesAmmount" class="fadeIn second" name="BudgetPlacesAmmount" placeholder="<fmt:message key="viewFaculties.BudgetPlacesAmount"/>" required>
                <input type="text" id="PlacesAmmount" class="fadeIn third" name="PlacesAmmount" placeholder="<fmt:message key="viewFaculties.PlacesAmount"/>" required>
